...
function createPropertyCard(propertyKey, propertyData) {
    ...
    const accommodation = propertyData['Property Information']?.['Accommodation'] || 'Information not available';
    return `
        <a href="/src/html/pages/model.html?property=${encodeURIComponent(propertyKey)}" class="property-card">
            ...
            <div class="property-info">
                <h2 class="property-name">${propertyData.property_title.replace(/Welcome\s*(?:to)?\s*/i, '').replace(/\n/g, '<br>')}</h2>
