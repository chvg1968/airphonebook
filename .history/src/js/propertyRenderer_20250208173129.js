...
function renderProperty(template, propertyKey, propertyData) {
    console.log('Renderizando propiedad:', propertyKey, propertyData);
    let html = template;
    ...
    // Verificar y reemplazar la información de WiFi
    ...
    // Verificar y reemplazar la información de estacionamiento
