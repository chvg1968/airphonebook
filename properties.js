export const villas = {
  ...
  "Villa Paloma": {
    ...
    "Important Villa Information": {
      content:
        ...
        <li><strong>Thermostats to regulate the 2 A/C units' temperature are located:</strong>\
          <ul style='list-style: none; padding-left: 20px; margin-top: 5px;'>\
            <li>In the A/C closet to the right of the apartment after the entrance</li>\
          </ul>\
        </li>\
        <li><strong>Grill:</strong> Turn off the gas after using the grill</li>\
        <li><strong>Terrace door:</strong> Lock the terrace door when not at the villa. The door may occasionally open due to airflow</li>\
  ...
  "Villa Palacio": {
    ...
    "Important Villa Information": {
      content:
        ...
        <li><strong>Thermostats to regulate the 2 A/C units' temperature are located:</strong>\
          <ul style='list-style: none; padding-left: 20px; margin-top: 5px;'>\
            <li>In the 2 A/C closets on the hallway to the left of the apartment after the main entrance</li>\
          </ul>\
        </li>\
        <li><strong>Grill:</strong> Turn off the gas after using the grill</li>\
        <li><strong>Terrace door:</strong> Lock the terrace door when not at the villa. The door may occasionally open due to airflow</li>\
  ...
  "Villa Flora": {
    ...
    "Important Villa Information": {
      content:
        ...
        <li><strong>Thermostats to regulate the 2 A/C units' temperature are located:</strong>\
          <ul style='list-style: none; padding-left: 20px; margin-top: 5px;'>\
            <li>In the A/C closet to the right of the apartment after the main entrance</li>\
          </ul>\
        </li>\
        <li><strong>Grill:</strong> Turn off the gas after using the grill</li>\
        <li><strong>Terrace door:</strong> Lock the terrace door when not at the villa. The door may occasionally open due to airflow</li>\
  ...
  "Villa Tiffany": {
    property_title: "Villa Tiffany/Unit 10389<br>Las Verandas",
    location: "/assets/images/mapverandas.jpg",
  ...
  "Ocean View Villa": {
    property_title: "Ocean View Villa/Unit 2-315<br>Las Ventanas",
    location: "/assets/images/mapventanas.jpg",
    ...
    "Wifi Information": {
      ...
      "qr_code_resort": "/assets/images/wifi_qr_resort.png",
      "villa_network": "LIB-9600949",
      "villa_password": "Mvgygn2za2wJ",
      "resort_network": "Bahia Beach Resort",
      "resort_password": "welcomeHome<br>Note: The H in Home is capitalized",
    },
    "Property Information": {
      Accommodation:
        "3 bedroom/ 3 bathroom<br>Amazing View Beachfront<br>8 Guests",
    },
    "Parking Information": {
      "Parking spots": "29 y 30",
      "Golf Cart": "49",
      "Golf Cart Parking Spot": "G-27",
    },
    "Important Villa Information": {
      content:
        "<ul class='info-list' style='list-style: none;'>\
