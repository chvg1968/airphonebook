...
export async function buildTree() {
    try {
        ...
        backToMenuBtn.addEventListener("click", () => {
            // Si estamos en la vista de subcategorías (currentCategory definido), retroceder a la vista de categorías
            if (currentCategory) {
                currentCategory = null;
                contactsList.innerHTML = '';
                ...
                // Si estamos en la vista de categorías, regresar a la vista de secciones
